#!/usr/bin/env python3
"""
Process Apollo 15 Flight and Surface Journal HTML files and convert them to JSON format.
...
def process_journal_files():
    ...
    exclude_files = ['ap15fj_index.html', 'a15_original_main.html', 'flight_journal_links.txt', 'surface_journal_links.txt']
